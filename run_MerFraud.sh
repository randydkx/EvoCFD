...
STAGE2_KEEP_RATIO=${STAGE2_KEEP_RATIO:-0.85}
...
STAGE3_KEEP_RATIO=${STAGE3_KEEP_RATIO:-0.35}
...
for stage in "${STAGES[@]}"; do
    ...
    case "${stage}" in
        ...
        stage_2)
            ...
            exp_name="${EXP_PREFIX}_stage2_best_r0.85_seed${SEED}"
            ;;
        stage_3)
            ...
            exp_name="${EXP_PREFIX}_stage3_best_r0.35_seed${SEED}"
            ;;
        *)
            exit 1
            ;;
