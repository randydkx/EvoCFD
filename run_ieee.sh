...
STAGE1_TIME_LR=${STAGE1_TIME_LR:-0.0009}
STAGE1_HEAD_LR=${STAGE1_HEAD_LR:-0.0016}
STAGE1_BN_LR=${STAGE1_BN_LR:-0.00007}
STAGE1_TOKENIZER_LR=${STAGE1_TOKENIZER_LR:-0.0006}

STAGE2_KEEP_RATIO=${STAGE2_KEEP_RATIO:-0.33}
...
STAGE3_KEEP_RATIO=${STAGE3_KEEP_RATIO:-0.8992}
...
for stage in "${STAGES[@]}"; do
    ...
    case "${stage}" in
        ...
        stage_2)
            ...
            exp_name="${EXP_PREFIX}_stage2_best_r0.33_seed${SEED}"
            ;;
        stage_3)
            ...
            exp_name="${EXP_PREFIX}_stage3_best_r0.8992_seed${SEED}"
            ;;
        *)
            exit 1
            ;;
